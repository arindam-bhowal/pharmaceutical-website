...
const WorkerState = (props) => {
  ...
  const fetchAllWorkers = async () => {
     ...
     const newWorker = async (name, email, password, phoneNumber, age, sex, profilePic, govtId, referals ,referalId, percentPerReferal) => {
        try {
            await axios.post(`${host}/worker/register`, {name, email, password, phoneNumber, age, sex, profilePic, govtId, referals ,referalId, percentPerReferal})
            return 'success'
        } catch (error) {
            return 'error'
        }
