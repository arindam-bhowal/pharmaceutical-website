  ...
  const handleSubmit = async (e) => {
    ...
    password === cPassword ? 
      (await registerDoctor(
        ...
        referalId,
        percentPerReferal
      )) : (alert('Password do not match') && navigate('/register'));
    navigate("/login");
  };
            ...
            <div className>
              <form onSubmit={handleSubmit}>
                ...
                <div style={{margin: '20px'}}>
                  <label htmlFor="sex"  style={{margin: '20px'}}>SEX : </label>
                  <select id="sex" onChange={(e) => { e.target.value !=='' && setSex(e.target.value)} }>
                ...
                <div className="input_field">
                  ...
                  <input type="number" name="age" placeholder="Age" required onChange={(e) => setAge(e.target.value)} />
                </div>
